# Operator Quickstart — Card Transaction Processing and Settlement

Shortest path from clone to a verified local dry-run for **ISIC 6619** (`cloud-itonami-isic-6619`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6619.git
cd cloud-itonami-isic-6619
```
...
- Blueprint governor key: `card-settlement-governor`
- Likely source path: `card.governor.cljc`
